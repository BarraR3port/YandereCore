...
public class BanMenu extends Menu {
    ...
    public BanMenu(IPlayerMenuUtility playerMenuUtility, User target){
    ...
    public String getMenuName(){
        return "&4• &8Ban Menu | Elige una opción:";
    }
    ...
    public void handleMenu(InventoryClickEvent event){
        ...
        if (item.hasTag("reason")){
            ...
            new BanAmountMenu(this.playerMenuUtility, target, reason).open();
        }
    ...
    private ItemStack hacking(){
        return new ItemBuilder(new ItemStack(Material.RED_ROSE))
                ...
                .addLoreLine("&7Banear a " + target.getName() + " por Hacking.")
    ...
    private ItemStack killaura(){
        return new ItemBuilder(new ItemStack(Material.DIAMOND_SWORD))
                ...
                .addLoreLine("&7Banear a " + target.getName() + " por KillAura.")
    ...
    private ItemStack flying(){
        return new ItemBuilder(new ItemStack(Material.FEATHER))
                ...
                .addLoreLine("&7Banear a " + target.getName() + " por Flying.")
    ...
    private ItemStack speed(){
        return new ItemBuilder(new ItemStack(Material.SUGAR))
                ...
                .addLoreLine("&7Banear a " + target.getName() + " por Speed.")
                .addTag("reason", "Speed")
                .build();
    }
    ...
    private ItemStack griefing(){
        return new ItemBuilder(new ItemStack(Material.TNT))
                ...
                .addLoreLine("&7Banear a " + target.getName() + " por Griefing.")
    ...
    private ItemStack bhop(){
        return new ItemBuilder(new ItemStack(Material.RABBIT_HIDE))
                ...
                .addLoreLine("&7Banear a " + target.getName() + " por BunnyHop.")
    ...
    private ItemStack other(){
        return new ItemBuilder(new ItemStack(Material.BOWL))
                ...
                .addLoreLine("&7Banear a " + target.getName() + " por otra razón.")
                .addTag("reason", "other")
                .build();
    }
